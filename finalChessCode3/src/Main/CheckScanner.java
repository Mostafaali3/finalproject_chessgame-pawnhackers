...
public class CheckScanner {
    ...
    public boolean isKingChecked(Move move){
        ...
        return  hitByCastle(move.newCol,move.newRow,king,kingCol,kingRow,0,1)||  //up
                hitByCastle(move.newCol,move.newRow,king,kingCol,kingRow,1,0)||  //right
                hitByCastle(move.newCol,move.newRow,king,kingCol,kingRow,0,-1)|| //down
                hitByCastle(move.newCol,move.newRow,king,kingCol,kingRow,-1,0)|| //left

                hitByBishop(move.newCol,move.newRow,king,kingCol,kingRow,-1,-1)|| //up
...
private boolean hitByCastle(int col,int row,Piece king,int kingCol,int kingRow,int colVal,int rowVal) {
    for (int i = 1; i < 8; i++) {
        ...
        if(piece!=null && piece!=board.selectedPiece){
            if(!board.sameTeam(piece,king)&&(piece.name.equals("Castle")||piece.name.equals("Queen"))){
                return true;
            }
            break;
        }
