...
//        if ( Math.abs(move.piece.col- move.newCol)==4) {
//            Piece castle;
...
//    }
    public void castling() {
            for (Piece piece1 : pieceList) {
                if (piece1.col == 7 && piece1.row == 0&&piece1.name.equals("Castle")&&piece1.movesCounter==0 && !piece1.isWhite) {
            ...
            else if (piece1.col == 7 && piece1.row == 7&&piece1.name.equals("Castle")&&piece1.movesCounter==0&& piece1.isWhite) {
                ...
                else if (piece1.col == 0 && piece1.row == 7&&piece1.name.equals("Castle")&&piece1.movesCounter==0&& piece1.isWhite) {
                ...
                else if (piece1.col == 0 && piece1.row == 0&&piece1.name.equals("Castle")&&piece1.movesCounter==0 && !piece1.isWhite) {
        ...
        //pieceList.add(new Castle(this, 5, 0, false));
        //pieceList.remove(this.getPiece(7, 0));

//        }      }
////
//    }}
// public void castling (Castle castle, King king , Move move2){
//        if(castle.isFirstMove&&king.col==6){
//
//            move2= new Move( this,castle,5,castle.row);
//
//        }
//        else if(castle.isFirstMove&&king.col==2){
//        move2 =new Move( this,castle,3,castle.row);
//
//     }
